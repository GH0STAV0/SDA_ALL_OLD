...
user_pref("app.update.lastUpdateTime.background-update-timer", 1646093571);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1646093331);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1646093451);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1646093300);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1646089200);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1646093374825");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1646095189825");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1646093328194");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1646114928194");
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220301);
...
user_pref("e10s.rollout.cohortSample", "0.588186");
user_pref("e10s.rollout.cohortSample.multi", "0.675294");
...
user_pref("extensions.shield-recipe-client.user_id", "e9509127-d18c-4235-8249-85b7adc2c337");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"dea629da-17dc-4a73-ad22-c26dabd33a69\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1646093422);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1646093417);
...
user_pref("toolkit.startup.last_success", 1646093299);
user_pref("toolkit.telemetry.cachedClientID", "2bd5b1df-0a18-4810-a737-1741163a7fbd");

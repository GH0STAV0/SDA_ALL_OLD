...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1645296198);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1645296167);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1645296223736");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1645298007736");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1645296187506");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1645317787506");
user_pref("browser.search.countryCode", "DZ");
user_pref("browser.search.region", "DZ");
user_pref("browser.shell.didSkipDefaultBrowserCheckOnFirstRun", true);
user_pref("browser.slowStartup.averageTime", 2882);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1645296184869");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.570713");
user_pref("e10s.rollout.cohortSample.multi", "0.075706");
...
user_pref("extensions.shield-recipe-client.user_id", "c4800334-2f07-48f3-9206-fd501df8a673");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"972c7345-7be9-41f3-822f-beabc0c9b2fb\"}");
...
user_pref("places.history.expiration.transient_current_max_pages", 16133);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1645296166);
user_pref("toolkit.telemetry.cachedClientID", "06dd04ec-7b8d-41b8-bf23-ad42b60e35f6");

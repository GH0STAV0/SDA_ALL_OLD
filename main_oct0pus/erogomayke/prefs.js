...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1646833370);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1646833339);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1646780400);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1646833416903");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1646835195903");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1646833354253");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1646854954253");
user_pref("browser.search.countryCode", "DZ");
user_pref("browser.search.region", "DZ");
user_pref("browser.shell.didSkipDefaultBrowserCheckOnFirstRun", true);
user_pref("browser.slowStartup.averageTime", 4504);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1646833347938");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.629582");
user_pref("e10s.rollout.cohortSample.multi", "0.791295");
...
user_pref("extensions.shield-recipe-client.user_id", "5926e83d-1e6a-4a0f-995c-7ff280712f45");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"bdfaf852-25ca-461a-8e86-e11a8fe9cfcd\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1646833438);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1646833437);
...
user_pref("places.history.expiration.transient_current_max_pages", 99210);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1646833338);
user_pref("toolkit.telemetry.cachedClientID", "173e2a81-4ffc-409c-8a37-1564c593f5f2");

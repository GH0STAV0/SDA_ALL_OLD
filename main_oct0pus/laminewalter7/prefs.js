...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1664052674);
...
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1663974000);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1664052652881");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1664074252881");
...
user_pref("browser.slowStartup.averageTime", 4233);
...
user_pref("e10s.rollout.cohortSample", "0.307829");
user_pref("e10s.rollout.cohortSample.multi", "0.588507");
...
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"a90ea78e-307c-4ef8-a916-a5f089e994a7\"}");
...
user_pref("marionette.port", 14171);
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1664052667);
...
user_pref("toolkit.startup.last_success", 1664052642);

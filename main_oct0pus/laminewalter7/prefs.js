...
user_pref("app.update.lastUpdateTime.background-update-timer", 1654809548);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1647361765);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1656210026);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1647361885);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1647361735);
user_pref("browser.laterrun.bookkeeping.sessionCount", 2);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationExpired", true);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1647298800);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1654809522);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1656210064545");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1656211853545");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1656210074049");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1656231674049");
...
user_pref("browser.slowStartup.averageTime", 3462);
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220315);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 2);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1647361741060");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.446580");
user_pref("e10s.rollout.cohortSample.multi", "0.406121");
...
user_pref("extensions.shield-recipe-client.user_id", "b4af737c-492e-4823-b3fa-0a460e360551");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"d3684cda-cb0d-45e8-9920-3e3cc8bd1ab9\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1647361780);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1656210031);
...
user_pref("toolkit.startup.last_success", 1656209995);
user_pref("toolkit.telemetry.cachedClientID", "b6e31c56-df53-470a-9397-4b5ef1a0f6ab");

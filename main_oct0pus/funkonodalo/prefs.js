...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1645297043);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1645297013);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1645297078623");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1645298852623");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1645297039153");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1645318639153");
user_pref("browser.search.countryCode", "DZ");
user_pref("browser.search.region", "DZ");
user_pref("browser.shell.didSkipDefaultBrowserCheckOnFirstRun", true);
user_pref("browser.slowStartup.averageTime", 2740);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1645297020687");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.441757");
user_pref("e10s.rollout.cohortSample.multi", "0.701672");
...
user_pref("extensions.shield-recipe-client.user_id", "5fc38d53-7ff2-4da3-a35b-88c849cc0a18");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"578a5c1e-c91c-42e2-b418-a4b9f4679cd6\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1645297050);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1645297049);
...
user_pref("places.history.expiration.transient_current_max_pages", 14825);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1645297012);
user_pref("toolkit.telemetry.cachedClientID", "c4ea8316-4ede-4924-b6b9-d08d1f67176e");

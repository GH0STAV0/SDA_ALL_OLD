...
user_pref("app.update.lastUpdateTime.background-update-timer", 1645259334);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1645259094);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1645259214);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1645259064);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1645225200);
user_pref("browser.newtabpage.activity-stream.migrationRemainingDays", 3);
user_pref("browser.newtabpage.enhanced", true);
user_pref("browser.newtabpage.storageVersion", 1);
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1645259074);
...
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1645259091355");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1645280691355");
user_pref("browser.search.countryCode", "DZ");
user_pref("browser.search.region", "DZ");
user_pref("browser.shell.didSkipDefaultBrowserCheckOnFirstRun", true);
user_pref("browser.slowStartup.averageTime", 2569);
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220219);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 0);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1645259084506");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.111573");
user_pref("e10s.rollout.cohortSample.multi", "0.771595");
...
user_pref("extensions.shield-recipe-client.user_id", "b5f48e8c-e08c-491d-aaba-510d79556a0c");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"1e9450cf-34ac-417b-8545-7bb31a55d300\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1645259181);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1645259150);
...
user_pref("places.history.expiration.transient_current_max_pages", 18264);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1645259063);
user_pref("toolkit.telemetry.cachedClientID", "d4a07841-7ddc-4e8d-9479-f7b41e938099");

...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1645258394);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1645258364);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1645258434814");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1645260218814");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1645258378274");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1645279978274");
user_pref("browser.search.countryCode", "DZ");
user_pref("browser.search.region", "DZ");
user_pref("browser.shell.didSkipDefaultBrowserCheckOnFirstRun", true);
user_pref("browser.slowStartup.averageTime", 2502);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1645258373498");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.785150");
user_pref("e10s.rollout.cohortSample.multi", "0.557125");
...
user_pref("extensions.shield-recipe-client.user_id", "3822374e-7f8b-46c3-b5e8-41baf467ed68");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"37e77fa8-4da3-45bd-9de8-87d2d3efc3aa\"}");
...
user_pref("places.history.expiration.transient_current_max_pages", 20353);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1645258363);
user_pref("toolkit.telemetry.cachedClientID", "d6efdc06-b22c-4bb3-b8c3-6ed97ddceff4");

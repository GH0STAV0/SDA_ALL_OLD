...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1647818380);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1654610716);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1647818350);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1654610687);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1647818393773");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1647820194773");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1647818360920");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1647839960920");
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220607);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 1);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1647818354974");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.799493");
user_pref("e10s.rollout.cohortSample.multi", "0.392208");
...
user_pref("extensions.shield-recipe-client.user_id", "41313333-b10b-4140-be97-268c8d248e28");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"11b8646d-b4a5-43ac-9fe9-e0da830f2097\"}");
...
user_pref("toolkit.startup.last_success", 1654610684);
user_pref("toolkit.telemetry.cachedClientID", "e768a092-0a0b-4cb5-a4d2-91e77e329642");

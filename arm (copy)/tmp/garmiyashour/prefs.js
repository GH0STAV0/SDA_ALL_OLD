...
user_pref("app.update.lastUpdateTime.background-update-timer", 1660444971);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1647817768);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1655122886);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1647817737);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1655122091);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1660444981229");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1660446780229");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1660444984579");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1660466584579");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1660444943");
user_pref("browser.slowStartup.averageTime", 2355);
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220814);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 0);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1647817744334");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.138032");
user_pref("e10s.rollout.cohortSample.multi", "0.862815");
...
user_pref("extensions.shield-recipe-client.user_id", "72589167-c582-46f9-845e-e6d65c9baf44");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"a05ab56e-a7b2-4574-8b55-e0ae39b678e5\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1655122893);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1655122883);
...
user_pref("toolkit.startup.last_success", 1660444940);
user_pref("toolkit.telemetry.cachedClientID", "a058fe8e-af23-4087-9ced-8e4245aae439");

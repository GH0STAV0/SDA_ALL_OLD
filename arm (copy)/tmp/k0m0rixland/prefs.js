...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1662975311);
user_pref("app.update.lastUpdateTime.background-update-timer", 1650320985);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1650320745);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1655396170);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1650320865);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1650320715);
user_pref("browser.laterrun.bookkeeping.sessionCount", 2);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationExpired", true);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1650254400);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1655396142);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1662975312984");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1662977084984");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1662975314164");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1662996914164");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1662975283");
user_pref("browser.slowStartup.averageTime", 2591);
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220418);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 0);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1650320725008");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.070873");
user_pref("e10s.rollout.cohortSample.multi", "0.094483");
...
user_pref("extensions.shield-recipe-client.user_id", "9f1812f7-33a9-4f27-9a28-5eaf83cb94d9");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"directory\":\"{84ef46ac-dbb7-45fb-bb56-d68a8f683eb9}\",\"addons\":{\"disable-crash-autosubmit@mozilla.org\":{\"version\":\"2.1\"},\"disable-js-shared-memory@mozilla.org\":{\"version\":\"2.0\"},\"disable-media-wmf-nv12@mozilla.org\":{\"version\":\"1.1\"},\"hotfix-bug-1548973@mozilla.org\":{\"version\":\"1.1.4\"}}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"277c3f5e-679a-403f-b6d1-734cc142b665\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1650320779);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1662975381);
...
user_pref("toolkit.startup.last_success", 1662975280);
user_pref("toolkit.telemetry.cachedClientID", "d0aae407-945c-4bfb-bbde-91c46fae254f");

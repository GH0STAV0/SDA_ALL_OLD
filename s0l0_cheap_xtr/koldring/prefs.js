...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1650488332);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1650488452);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1650488301);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1650409200);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1650488368697");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1650490141697");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1650488313145");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1650509913145");
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20220420);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 0);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1650488310104");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.476180");
user_pref("e10s.rollout.cohortSample.multi", "0.161240");
...
user_pref("extensions.shield-recipe-client.user_id", "f385a514-2a56-4b75-ab92-30a9c625e87c");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"8b0d41a5-c520-4420-bc46-17d09f7b4b9c\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1650488525);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1650488524);
...
user_pref("places.history.expiration.transient_current_max_pages", 49936);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1650488299);
user_pref("toolkit.telemetry.cachedClientID", "419fd298-57e8-427e-a577-6432a23e0388");

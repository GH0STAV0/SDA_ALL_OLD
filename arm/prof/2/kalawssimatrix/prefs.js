...
user_pref("app.update.lastUpdateTime.background-update-timer", 1655396891);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1650592890);
user_pref("app.update.lastUpdateTime.experiments-update-timer", 1662977864);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1650672876);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1650592860);
user_pref("browser.laterrun.bookkeeping.sessionCount", 3);
user_pref("browser.migration.version", 59);
user_pref("browser.newtabpage.activity-stream.migrationExpired", true);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1650668400);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1650592970);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1662977876951");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1662979699951");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1662977878438");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1662999478438");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1662977835");
user_pref("browser.slowStartup.averageTime", 1994);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1650592867093");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.153072");
user_pref("e10s.rollout.cohortSample.multi", "0.389951");
...
user_pref("extensions.shield-recipe-client.user_id", "4fc3361d-c75a-49d2-a121-7608ae8d9c53");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"05dab276-1a2f-485b-9db9-d9fb2a0c38bf\"}");
user_pref("gecko.handlerService.migrated", true);
user_pref("media.gmp-gmpopenh264.abi", "x86_64-gcc3");
user_pref("media.gmp-gmpopenh264.lastUpdate", 1650672886);
user_pref("media.gmp-gmpopenh264.version", "1.7.1");
user_pref("media.gmp-manager.buildID", "20171128222554");
user_pref("media.gmp-manager.lastCheck", 1655396917);
...
user_pref("toolkit.startup.last_success", 1662977833);
user_pref("toolkit.telemetry.cachedClientID", "c7b6b40a-d6cc-4fc3-8511-ed0bb5191eb9");

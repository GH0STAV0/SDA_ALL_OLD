...
user_pref("app.update.lastUpdateTime.background-update-timer", 1662977470);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 0);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1650584231);
...
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1655396548);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1650584201);
...
user_pref("browser.onboarding.notification.last-time-of-changing-tour-sec", 1655396519);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1662977491844");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1662979320844");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1662977493583");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1662999093583");
...
user_pref("browser.shell.mostRecentDateSetAsDefault", "1662977442");
user_pref("browser.slowStartup.averageTime", 3084);
...
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1650584208753");
user_pref("dom.ipc.processCount.web", 4);
user_pref("e10s.rollout.cohort", "multiBucket4");
user_pref("e10s.rollout.cohortSample", "0.455868");
user_pref("e10s.rollout.cohortSample.multi", "0.560274");
...
user_pref("extensions.shield-recipe-client.user_id", "13bb2fb1-0778-46f1-a54c-e2e81470859b");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"9dacbf65-ab60-45fb-81d8-504a4138a23e\"}");
...
user_pref("toolkit.startup.last_success", 1662977439);
user_pref("toolkit.telemetry.cachedClientID", "62a77705-40b5-4de2-9b02-2a9e7d213aeb");

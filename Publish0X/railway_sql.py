...
def check_connect_mysql_railway():
	# mydb = mysql.connector.connect(host="containers-us-west-30.railway.app",user="root",passwd="g10o42QI4J35Rdl3rBrB",database="railway",port=5672)
